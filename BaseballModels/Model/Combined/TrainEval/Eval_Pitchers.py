...
def Eval_Pitchers(eval_update : bool, train_only : bool):
    Eval_Players(eval_update, is_hitter=False, train_only=train_only)
...
if __name__ == "__main__":
    ...
    if request_type == "All":
        Eval_Pitchers(False, train_only)
    elif request_type == "Update":
        Eval_Pitchers(True, train_only)
    else:
