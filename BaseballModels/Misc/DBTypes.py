...
class DB_PitchStatcast:
	def __init__(self, values : tuple[any]):
		...
		self.PaResultOccupancy = values[14]
		self.PaResultOuts = values[15]
		self.PaResultDirectRuns = values[16]
		self.RunsAfterPa = values[17]
		self.Result = values[18]
		self.HadSwing = values[19]
		self.HadContact = values[20]
		self.IsInPlay = values[21]
		self.HitIsR = values[22]
		self.PitIsR = values[23]
		self.vX = values[24]
		self.vY = values[25]
		self.vZ = values[26]
		self.vStart = values[27]
		self.vEnd = values[28]
		self.aX = values[29]
		self.aY = values[30]
		self.aZ = values[31]
		self.pfxX = values[32]
		self.pfxZ = values[33]
		self.BreakAngle = values[34]
		self.BreakVertical = values[35]
		self.BreakInduced = values[36]
		self.BreakHorizontal = values[37]
		self.SpinRate = values[38]
		self.SpinDirection = values[39]
		self.pX = values[40]
		self.pZ = values[41]
		self.ZoneTop = values[42]
		self.ZoneBot = values[43]
		self.Extension = values[44]
		self.x0 = values[45]
		self.y0 = values[46]
		self.z0 = values[47]
		self.PlateTime = values[48]
		self.LaunchSpeed = values[49]
		self.LaunchAngle = values[50]
		self.TotalDist = values[51]
		self.HitCoordX = values[52]
		self.HitCoordY = values[53]
		self.RunValueHitter = values[54]
