namespace UI.Controls.TestRunnerGraphViewer
{
    partial class SelectionDetailTable
    {
        ...
        private void InitializeComponent()
        {
            ...
            tlpMain.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50F));
            tlpMain.Controls.Add(labelStar, 1, 5);
            tlpMain.Controls.Add(label11, 0, 5);
            tlpMain.Controls.Add(labelStarter, 1, 4);
            tlpMain.Controls.Add(label9, 0, 4);
            tlpMain.Controls.Add(labelBackup, 1, 3);
            tlpMain.Controls.Add(label7, 0, 3);
            tlpMain.Controls.Add(labelBust, 1, 2);
            tlpMain.Controls.Add(label5, 0, 2);
            tlpMain.Controls.Add(labelWar, 1, 1);
            tlpMain.Controls.Add(label3, 0, 1);
            tlpMain.Controls.Add(labelDate, 1, 0);
